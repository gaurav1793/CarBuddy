  ...
  return (
    <div>
            ...
            <div className=' space-y-6'>
                <h3 className="font-semibold text-2xl  ">Finish Ride</h3>
                <div className='flex items-center justify-between mt-3 p-3 bg-yellow-300 rounded-lg' >
                    <div className='flex items-center gap-3 '>
                        ...
                        <h2 className='text-lg font-medium'>katrnia Kataria</h2>
                    </div>
                ...
                <div className='space-y-4 '>
                    ...
                    <div >
                                <Link
                                    ...
                                    className='text-lg w-full h-[50px] flex justify-center items-center bg-green-500 rounded-lg text-white text-center'>Finish Ride</Link>

                                    <p className='text-gray-500 text-xs mt-1 text-center'>click on finish ride if Payment is completed</p>
                    </div>
                </div>
