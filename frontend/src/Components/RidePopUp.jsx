    ...
    return (
        <div>
            ...
            <div className=' space-y-6'>
                <h3 className="font-semibold text-2xl  ">New Ride Request</h3>
                ...
                <div className='space-y-4 '>
                    ...
                    <button
                        ...
                        className=' p-3 h-[50px] bg-gray-400 rounded-lg text-gray-700 text-center px-10'>Reject</button>
                    <button
                        onClick={() => {
                            props.setConfirmridePopupPanel(true);
                        }}
                        className='p-3 h-[50px] bg-green-500 rounded-lg text-white text-center px-8'>Accept</button>
