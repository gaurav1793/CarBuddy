                    ...
                    <div >
                        ...
                        onSubmit={(e)=>{
                            ...
                            <input type='text'
                             ...
                             className="w-full px-6 py-4 font-mono border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:outline-none" placeholder='Enter OTP' />
                           
                                <Link
                                    to='/captain-riding'
                                    onClick={() => {
                                    }}
                                    className='w-full text-lg h-[50px] flex justify-center items-center bg-green-500 rounded-lg text-white text-center'>Confirm</Link>
                                <button
                                    onClick={() => {
                                        props.setConfirmridePopupPanel(false);
                                        props.setridePopupPanel(false);
                                    }}
                                    className='w-full h-[50px] bg-red-600 rounded-lg text-white text-center'>Cancel</button>
